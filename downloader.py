...
Shell Game Podcast Transcripts GitHub repository. 
"""
import os
import zipfile
import requests
...
def unzip_file(zip_path):
    ...
    extracted_folder = os.path.join(cwd, "Shell-Game-Transcripts-main")
    if os.path.exists(extracted_folder):
        new_folder_name = "Shell-Game-Transcripts"
...
if __name__ == "__main__":
    ...
    url = "https://github.com/willtheorangeguy/Shell-Game-Transcripts/archive/refs/heads/main.zip"
    output_zip = "shell_game_transcripts.zip"
