...
<div align="center">
  ...
  <!-- Language Count -->
  <img alt="GitHub Languages" src="https://img.shields.io/github/languages/count/willtheorangeguy/Shell-Game-Transcripts">
</div>
...
- Pull all the Shell Game podcast episodes, and convert them to audio.
...
**To clone and run your own copy of this website**, you'll need [Git](https://git-scm.com/downloads), [Ollama](https://ollama.com/) and a bunch of Python libraries installed on your computer. If you would rather not use Git, you can just download the code from GitHub [above](https://github.com/willtheorangeguy/Shell-Game-Transcripts/archive/refs/heads/main.zip). From your command line:
...
If support is required, please open a **[GitHub Discussion](https://github.com/willtheorangeguy/Shell-Game-Transcripts/discussions/new)** or join our **[Discord](https://discord.gg/mgbda4fesN)**.
